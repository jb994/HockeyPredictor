...
print_individual_stats=True # Prints the individual predicted stats for each player
...
def main():
	...
	home_team="S.J" # From codes above
	away_team="COL" # From codes above
	day_of_week='Sunday' # [["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]]
	todays_date=20200308 #yyyymmdd
